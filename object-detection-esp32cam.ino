/* reference by Somnath Bera
March 17, 2023. Object Detection Using ESP32 Cam
https://www.electronicsforu.com/electronics-projects/hardware-diy/object-detection-using-esp32-cam
*/

const char* ssid     = "localnetworkAP";      //Define your own SSID
const char* password = "AP_Password";   // Define your own password
